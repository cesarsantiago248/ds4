...
{
    public partial class Tren_Viajes : System.Web.UI.Page
    {
        ...
        private void LoadViajesData()
        {
            ...
            using (SqlConnection conexion = new SqlConnection(connString.ConnectionString))
            {
                ...
                string query = "SELECT * FROM tren_boletos_clientes LEFT JOIN tren_viajes ON tren_boletos_clientes.id_viaje = tren_viajes.id_viaje";
