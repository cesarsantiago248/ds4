...
{
    public partial class Avión_Viajes : System.Web.UI.Page
    {
        ...
        private void LoadViajesData()
        {
            ...
            using (SqlConnection conexion = new SqlConnection(connString.ConnectionString))
            {
                ...
                string query = "SELECT * FROM avion_boletos_clientes LEFT JOIN avion_viajes ON avion_boletos_clientes.id_viaje = avion_viajes.id_viaje";
