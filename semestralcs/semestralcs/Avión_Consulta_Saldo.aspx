<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Avión_Consulta_Saldo.aspx.cs" Inherits="semestralcs.Avión_Consulta_Saldo" %>
...
<form id="form1" runat="server">
    <div>
        ...
        <br />
        <br />
        <asp:Label ID="Label7" runat="server" Text="Servicios de Avión - Consulta de Saldo y Tarifas"></asp:Label>
        <br />
        ...
        <br />
        <br />
        <asp:Label ID="Label9" runat="server" Text="Actualmente tu cuenta de servicio de Avión cuenta con el siguiente saldo:"></asp:Label>
        <br />
        ...
        <hr />
        <br />
        <asp:Button ID="btn_return" runat="server" OnClick="btn_return_Click" Text="Regresa al portal" Width="207px" />
        <br />
        <br />
