<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Portal_Tren.aspx.cs" Inherits="semestralcs.Portal_Tren" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btn_viajes" runat="server" Text="Ver mis viajes agendados" Width="227px" OnClick="btn_viajes_Click" />
            <br />
            <hr />
            <br />
            <asp:Button ID="btn_return" runat="server" OnClick="btn_return_Click" Text="Regresa a Home" Width="230px" />
            <br />
            <br />
