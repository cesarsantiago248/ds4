<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Avión_Viajes.aspx.cs" Inherits="Semestral.Funciones_Avion.Avión_Viajes" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:Label ID="Label7" runat="server" Text="Servicios de Avión - Observa tus viajes agendados"></asp:Label>
            <br />
