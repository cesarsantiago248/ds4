<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Portal_Tren.aspx.cs" Inherits="Semestral.Portal_Tren" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:Label ID="Label7" runat="server" Text="Portal de Servicios de Tren"></asp:Label>
            <br />
            <asp:Label ID="Label8" runat="server" Text="En que tren nos vamos hoy?"></asp:Label>
            <br />
            <hr />
            <br />
            ...
            <br />
            <br />
            <asp:Button ID="btn_tren" runat="server" Text="Consulta saldo/tarifas" Width="227px" />
            <br />
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btn_bus" runat="server" Text="Agregar saldo a cuenta" Width="227px" />
            <br />
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btn_avion" runat="server" Text="Agendar viajes" Width="227px" />
            <br />
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btn_avion0" runat="server" Text="Ver mis viajes agendados" Width="227px" />
            <br />
            <hr />
            <br />
            <br />
