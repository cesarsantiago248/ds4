<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tren_Viajes.aspx.cs" Inherits="Semestral.Funciones_Tren.Tren_Viajes" %>
...
<body>
    <form id="form2" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:Label ID="Label7" runat="server" Text="Servicios de Tren - Observa tus viajes agendados"></asp:Label>
            <br />
