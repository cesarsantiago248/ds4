<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bus_Agregar_Saldo.aspx.cs" Inherits="Semestral.Funciones_Bus.Bus_Agregar_Saldo" %>
...
<body>
    <form id="form2" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:Label ID="Label7" runat="server" Text="Servicios de Bus - Agrega Saldo a tu Cuenta"></asp:Label>
            <br />
