<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tren_Agendar.aspx.cs" Inherits="Semestral.Funciones_Tren.Tren_Agendar" %>
...
<body>
    <form id="form2" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:Label ID="Label7" runat="server" Text="Servicios de Tren - Agenda un viaje"></asp:Label>
            <br />
