<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tren_Agregar_Saldo.aspx.cs" Inherits="Semestral.Funciones_Tren.Tren_Agregar_Saldo" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:Label ID="Label7" runat="server" Text="Servicios de Tren - Agrega Saldo a tu Cuenta"></asp:Label>
            <br />
