<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Portal_Bus.aspx.cs" Inherits="Semestral.Portal_Tren" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:Label ID="Label7" runat="server" Text="Portal de Servicios de Autobús"></asp:Label>
            <br />
            <asp:Label ID="Label8" runat="server" Text="A donde quieres llegar?"></asp:Label>
            <br />
            <br />
            <hr />
            <br />
